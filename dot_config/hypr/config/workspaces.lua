...
-- config.workspaces_current (generated by scripts/monitors.sh on every
-- Hyprland start/hotplug, for every setup incl. this desktop) overrides
-- these with location-specific rules. This static block is only the
-- fallback used on the very first run, before that file has ever been
-- generated.
